...
export function registerServiceTools(server: McpServer, client: CwManageClient) {
  ...
  server.tool(
    "cw_list_ticket_types",
    "List ticket types for a specific service board in ConnectWise Manage.",
    {
      boardId: z.number().describe("Service board ID"),
      conditions: z.string().optional().describe("ConnectWise conditions query string"),
      page: z.number().optional().describe("Page number (default: 1)"),
  ...
  server.tool(
    "cw_list_ticket_subtypes",
    "List ticket subtypes for a specific service board in ConnectWise Manage.",
    {
      boardId: z.number().describe("Service board ID"),
      conditions: z.string().optional().describe("ConnectWise conditions query string"),
      page: z.number().optional().describe("Page number (default: 1)"),
  ...
  server.tool(
    "cw_list_ticket_items",
    "List ticket items for a specific service board in ConnectWise Manage.",
    {
      boardId: z.number().describe("Service board ID"),
      conditions: z.string().optional().describe("ConnectWise conditions query string"),
      page: z.number().optional().describe("Page number (default: 1)"),
  ...
  server.tool(
    "cw_list_ticket_type_subtype_associations",
    "List valid type/subtype/item associations for a specific service board in ConnectWise Manage. Use this to determine which subtype and item combinations are valid for a given ticket type.",
    {
      boardId: z.number().describe("Service board ID"),
      conditions: z.string().optional().describe("ConnectWise conditions query string"),
      page: z.number().optional().describe("Page number (default: 1)"),
    ...
    async ({ boardId, conditions, page, pageSize }) => {
      const result = await client.get(`/service/boards/${boardId}/typeSubTypeItemAssociations`, {
        conditions,
        page: page ?? 1,
        pageSize: pageSize ?? 25,
      });
